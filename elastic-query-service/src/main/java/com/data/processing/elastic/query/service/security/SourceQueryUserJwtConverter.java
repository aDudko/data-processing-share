...
import static com.data.processing.common.utils.Constants.NA;

@RequiredArgsConstructor
public class SourceQueryUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional.ofNullable(
                sourceQueryUserDetailsService.loadUserByUsername(jwt.getClaimAsString(USERNAME_CLAIM)))
                .map(userDetails -> {
                    ((SourceQueryUser) userDetails).setAuthorities(authoritiesFromJwt);
