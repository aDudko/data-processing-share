package com.data.processing.kafka.streams.service.config;

import com.data.processing.kafka.streams.service.security.KafkaStreamsUserDetailsService;
import com.data.processing.kafka.streams.service.security.KafkaStreamsUserJwtConverter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2ResourceServer((oauth2) -> oauth2
                        .jwt(jwt -> jwt.jwtAuthenticationConverter(kafkaStreamsUserJwtAuthConverter())));
        return http.build();
    }
